...
export default function App() {
    ...
    const maxPossible = questions.reduce((acc, question) => acc + question.points, 0);
    useEffect(function () {
    ...
    return (
        <div className="App">
            ...
            <Main>
                ...
                {status === 'finished' &&
                    <FinishScreen points={points} maxPossible={maxPossible} highscore={highscore} dispatch={dispatch} />
                }
            </Main>
        </div>
    );
